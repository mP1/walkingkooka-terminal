...
public interface TerminalServerContextDelegator extends TerminalServerContext {
    ...
    @Override
    default TerminalServerContext removeTerminalContext(final TerminalId terminalId) {
        this.terminalServerContext()
            .removeTerminalContext(terminalId);
        return this;
    }

    TerminalServerContext terminalServerContext();
}
